...
# Accumulo test data was generated from accumuloadapter/tests/setup_accumulo_data.py
...
def test_connection():
    with pytest.raises(IOError):
        adapter = accumuloadapter.AccumuloAdapter(server='bad hostname',
                                        username=username(),
                                        password=password(),
                                        table='ints')
    with pytest.raises(IOError):
        adapter = accumuloadapter.AccumuloAdapter(server=server(),
